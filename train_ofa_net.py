...
parser.add_argument('--ens', type=int, default=1, choices=[1, 2, 10])
parser.add_argument('--cbloss', type=bool, default=False)
parser.add_argument('--save-path', type=str, default='exp/temp')
parser.add_argument('--lr', type=float, default=0.001)
parser.add_argument('--beta', type=float, default=0.99)
parser.add_argument('--gamma', type=float, default=0.1)

parser.add_argument('--e', type=str, default='1.0')
...
if args.task == 'kernel':
    ...
    args.path = args.save_path
    args.dynamic_batch_size = 4
    if args.phase == 1:
        args.n_epochs = 25
        args.base_lr = 0.001 #2.5e-3
        args.warmup_epochs = 0
        args.warmup_lr = -1
        args.ks_list = '3'
...
if __name__ == '__main__':
    ...
    args.expand_list = [float(e) for e in args.expand_list.split(',')] # modified allowed float expand
    ...
    if args.ens == 1:
        ...
        classes = 2
    print('classes',classes,"   ens:",args.ens)
    net = OFAResNets18(
    ...
    if args.task == 'kernel':
        ...
        if args.phase == 1:
            args.ofa_checkpoint_path = "ofa-cifar-V3/exp/0218/ID50_Ens2_cecb_e[0.25~2.0]_w[2]_d[0,1]/checkpoint/model_best.pth.tar"
        else:
            args.ofa_checkpoint_path = "ofa-cifar-V3/exp/0218/ID50_Ens2_cecb_e[0.25~2.0]_w[2]_d[0,1]/checkpoint/model_best.pth.tar"
