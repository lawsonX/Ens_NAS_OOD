            ...
            for _ in range(args.dynamic_batch_size):
                        ...
                        if args.ens == 2:
                            ...
                            for temp in range(len(temp_target)):
                                if temp_target[temp] == i:
                                    ...
                                    temp_target[temp] = 1 
                            loss_sub += CB_loss(temp_target,out,[5000,450000],2,"focal",args.beta,args.gamma)
                ...
                if args.kd_ratio == 0:
                    ...
                    loss_type = '%.1fkd-%s & ce' % (args.kd_ratio,
                                                    args.kd_type)
                if args.ens != 1 and args.cbloss==True:
                    loss += loss_sub/args.ens
                    loss_type = 'ce+cb'
