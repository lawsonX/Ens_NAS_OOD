...
class ResNetArchEncoder:
	...
	def __init__(self, image_size_list=None, depth_list=None, expand_list=None, width_mult_list=None,
		...
		self.expand_list = [0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1.0, 1.125, 1.25, 1.375, 1.5, 1.625, 1.75, 2.0] if expand_list is None else expand_list
		self.depth_list = [0, 1] if depth_list is None else depth_list
		self.width_mult_list = [2.0] if width_mult_list is None else width_mult_list
	...
	def arch2feature(self, arch_dict):
		d, e, w = arch_dict['d'], arch_dict['e'], [0,0,0,0,0,0]
		r = 32
